            ...
            <div className="card bg-base-100 w-full max-w-3xl shrink-0 shadow-2xl mx-auto mb-10">
                <form onSubmit={handleSubmit(onSubmit)} className="card-body">
                    <div className="form-control">
                        ...
                        <input {...register("recipe", { required: true })} type="text" placeholder="recipe name" className="input input-bordered" required />
                    </div>
                    ...
                    <div className="form-control">
                        ...
                        <textarea {...register("recipeDetails", { required: true })} className="textarea textarea-bordered h-32" required placeholder="Bio"></textarea>
                    </div>
                    <div className='form-control'>
